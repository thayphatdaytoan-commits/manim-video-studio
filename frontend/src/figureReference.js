...
export function buildManimReferenceCode(manifest, constructionOrder) {
  ...
  lines.push(')')
  lines.push('# Sau ẩn đề: fit_figure_full_width(figure, config.frame_height*0.52); figure.to_edge(UP, buff=MARGIN)')
  lines.push('# Lời giải: next_to(figure, DOWN).align_to(LEFT_EDGE, LEFT)')
  lines.push('')
